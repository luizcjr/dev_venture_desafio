package com.luiz.gallery.ui.adapter;
...
/**
 * Adapter utilizado quando a requisição retorna vazio.
 * Com isso exibo esse adapter que contém uma mensagem para o usuário.
 */
