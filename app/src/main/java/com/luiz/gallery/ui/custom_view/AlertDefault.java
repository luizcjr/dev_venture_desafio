package com.luiz.gallery.ui.custom_view;
...
/**
 * Classe para criar custom dialogs.
 * Aqui eu posso adicionar botões e criar o listener com o evento de cada botão.
 * Por default, o dialog que não é adicionado botões tem um botão que quando clicado para de exibir o dialog.
 * Como parâmetro pode ser passado o título do dialog, o contéudo dele e um boolean que determina se é um dialog
 * de erro ou não. Caso seja de erro a imagem de erro também é exibido ao lado do título, caso não seja erro
 * a imagem de sucesso é exibido ao lado do título.
 */
